...
| 动态详情 | 正文、原图、评论、点赞用户、转发、编辑历史、站内分享与 App Deep Link | `/api/feeds/:id/*` |
| 发布与回复 | 本地草稿、文字、最多 9 张图片、拖放/粘贴、动态回复、评论回复 | `POST /api/feeds`、`POST /api/*/replies` |
| 应用市场 | 应用/游戏列表、详情、版本、评分、截图、相关动态 | `/api/apps/:id` |
| 话题 | 热门话题、搜索、详情、关注、动态列表 | `/api/web/topics/:tag` |
| 用户主页 | 资料、动态、文章、问答、收藏单、关注与粉丝分栏；公开列表匿名可读 | `/api/users/:uid/*` |
